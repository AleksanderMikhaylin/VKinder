...
from VKinder.handler.question.questions import AgeFromQuestion, AgeToQuestion, HometownQuestion, SexQuestion, StatusQuestion, TokenQuestion
from VKinder.model.tables import User, Candidate, Photo
